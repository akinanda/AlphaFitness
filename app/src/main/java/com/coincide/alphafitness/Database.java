...
public class Database extends SQLiteOpenHelper {
    ...
    private final static String TB_WORKOUTS = "workouts";
    ...
    public void onCreate(final SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TB_WORKOUTS + " (date INTEGER,steps INTEGER,distance REAL,time INTEGER,cal REAL)");
    }
    ...
    public void insertWorkouts(long date, int steps,float distance,int time, float cal) {
        ContentValues values = new ContentValues();
        values.put("date", date);
        values.put("steps", steps);
        ...
        values.put("cal", cal);
         ...
         long chk=   getWritableDatabase().insert(TB_WORKOUTS, null, values);
        if(chk!=-1) {
            if (BuildConfig.DEBUG) {
                Logger.log("saving workouts in db: " + steps + " date-" + date+" distance-" + distance + " time-" + time + " cal-" + cal);
            }
        }
    }

    public List<Pair<Float, Integer>> getWorkouts(int num) {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"date", "steps","distance","time","cal"}, null, null, null, null,
                        "date DESC", String.valueOf(num));
        int max = c.getCount();
        List<Pair<Float, Integer>> result = new ArrayList<>(max);
        if (c.moveToFirst()) {
            do {
                result.add(new Pair<>(c.getFloat(4), c.getInt(1)));
            } while (c.moveToNext());
        }
        return result;
    }
    ...
    public int getWorkTime() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"SUM(time)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
    ...
    public int getTotWorkouts() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"steps"}, "date > 0", null, null, null, null);
        int max = c.getCount();
    ...
    public int getAVGDistance() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"AVG(distance)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
    ...
    public int getAVGTime() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"AVG(time)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
    ...
    public int getMAXDistance() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"MAX(distance)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
    ...
    public int getMAXTime() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"MAX(time)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
    ...
    public int getMINDistance() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"MIN(distance)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
    ...
    public int getMINTime() {
        Cursor c = getReadableDatabase()
                .query(TB_WORKOUTS, new String[]{"MIN(time)"}, "date > 0", null, null, null, null);
        c.moveToFirst();
        int re = c.getInt(0);
        c.close();
        return re;
